...
public class Room{
    ...
    public Room(GL3 gl, Camera camera, Light light, int[] textureId1, int[] textureId2) {
        ...
        backWall = new Model(gl, camera, light, shader, material, modelMatrix, mesh, textureId2);
