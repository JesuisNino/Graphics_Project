...
//    private float xPosition = 5;
//    private TransformNode translateX, robotMoveTranslate, leftArmRotate, rightArmRotate;
//
//
//    public Table(GL3 gl, Camera camera, Light light, int[] textureId1, int[] textureId2,int[] textureId3,
...
//        leftArmRotate = new TransformNode("leftarm rotate",Mat4Transform.rotateAroundX(90));
//        m = new Mat4(1);
